...
///   - 文件导出
/// </summary>
public class PdfSharpExporterBehaviorTests
{
    private readonly PdfSharpExporter _exporter = new PdfSharpExporter();
    ...
    public void Export_EmptyReport_ThrowsInvalidOperationException()
    {
        ...
        // PdfSharpCore requires at least one page
        Assert.Throws<System.InvalidOperationException>(() => _exporter.Export(report));
    }

    [Fact]
    public void Export_SingleEmptyPage_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_SingleTextElement_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_MultipleTextElements_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_MultiplePages_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    public void ExportToFile_CreatesFile()
    {
        ...
        var tempFile = Path.Combine(Path.GetTempPath(), $"test_{System.Guid.NewGuid()}.pdf");
        try
        {
    ...
    [Fact]
    public void Export_TextWithBoldFont_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_TextWithBackgroundColor_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_TextWithBorder_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
    ...
    [Fact]
    public void Export_TextWithDifferentAlignments_GeneratesPdf()
    {
        var report = new RenderedReport
        {
            Template = new ReportTemplate(),
