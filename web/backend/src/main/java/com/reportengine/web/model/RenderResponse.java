package com.reportengine.web.model;
...
public class RenderResponse {
    ...
    public void setPages(List<PageInfo> pages) {
        this.pages = pages;
        this.totalPages = pages != null ? pages.size() : 0;
    }
    ...
    public static class PageInfo {
        ...
        public List<RenderedElementInfo> getElements() {
            return elements;
        }

        public void setElements(List<RenderedElementInfo> elements) {
